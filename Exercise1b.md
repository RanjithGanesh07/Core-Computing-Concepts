...
3. Read the burst time of each process and assign process IDs.
...
3. Type or paste the SJF scheduling program.
4. Save the file with the `.c` extension.
5. Compile the program.
6. Execute the program.
7. Enter the number of processes and their burst times.
...
<img width="1367" height="482" alt="image" src="https://github.com/user-attachments/assets/05f3e03f-26bd-4e03-9eec-0472ce9b6c1e" />
---
